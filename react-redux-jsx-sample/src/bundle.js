...
var Counter = function Counter(props) {
    return _react2.default.createElement(
        ...
        props.value.todos.map(function (obj, idx) {
            return _react2.default.createElement(
                'div',
                { key: idx },
                _react2.default.createElement(
                ...
                '\xA0',
                _react2.default.createElement('input', { value: obj, onChange: props.onModify(idx), style: { width: 350 } }),
                '\xA0',
                _react2.default.createElement(
                    'button',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    var actionCreators = {
        ...
        onModify: function onModify(index, value) {
            return { type: 'MODIFY', index: index, value: value };
        },
...
var App = function App(props) {
    ...
    return _react2.default.createElement(Counter, {
        value: props.value,
        onIncrement: function onIncrement() {
            return props.onIncrement({ type: 'INCREMENT' });
        },
        onDecrement: function onDecrement() {
            return props.onDecrement({ type: 'DECREMENT' });
        },
        onModify: function onModify(index) {
            return function (e) {
                return props.onModify({ type: 'MODIFY', index: index, value: e.target.value });
            };
        },
        onRemove: function onRemove(index) {
            return function () {
                return props.onRemove({ type: 'REMOVE', index: index });
            };
        }
    });
};
...
var renderByRedux = function renderByRedux() {
    return ReactDOM.render(_react2.default.createElement(
